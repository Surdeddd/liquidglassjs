...
const PALETTES: Record<string, Blob[]> = {
  ...
  dawn: [
    { x: 0.24, y: 0.82, r: 0.58, color: 'rgba(255, 180, 84, 0.3)' },
    { x: 0.72, y: 0.24, r: 0.52, color: 'rgba(255, 94, 158, 0.24)' },
    { x: 0.9, y: 0.74, r: 0.46, color: 'rgba(124, 92, 255, 0.28)' },
    { x: 0.08, y: 0.24, r: 0.42, color: 'rgba(94, 242, 220, 0.2)' }
  ]
}
